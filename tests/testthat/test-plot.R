...
test_that("layer parameters are correct", {
  ...
  expect_equal(deparse(p$layers[[1]]$mapping$x), "~x")
  expect_equal(deparse(p$layers[[1]]$mapping$y), "~y")
  expect_equal(deparse(p$layers[[1]]$mapping$group), "~group")
  ...
  expect_equal(deparse(s$layers[[1]]$mapping$x), "~x")
  expect_equal(deparse(s$layers[[1]]$mapping$y), "~y")
  expect_equal(deparse(s$layers[[1]]$mapping$group), "~group")
  ...
  expect_equal(deparse(s$layers[[2]]$mapping$x), "~x")
  expect_equal(deparse(s$layers[[2]]$mapping$y), "~y")
  expect_equal(deparse(s$layers[[2]]$mapping$label), "~abbr")
  expect_equal(as.character(s$layers[[2]]$aes_params$colour), "blue")

  expect_is(t$layers[[1]], "ggproto")
  expect_equal(deparse(t$layers[[1]]$mapping$x), "~x")
  expect_equal(deparse(t$layers[[1]]$mapping$y), "~y")
  expect_equal(deparse(t$layers[[1]]$mapping$group), "~group")
  ...
  expect_equal(deparse(t$layers[[2]]$mapping$x), "~x")
  expect_equal(deparse(t$layers[[2]]$mapping$y), "~y")
  expect_equal(deparse(t$layers[[2]]$mapping$label),
               "~sub(\" County\", \"\", county)")

  expect_is(u$layers[[1]], "ggproto")
  expect_equal(deparse(u$layers[[1]]$mapping$x), "~x")
  expect_equal(deparse(u$layers[[1]]$mapping$y), "~y")
  expect_equal(deparse(u$layers[[1]]$mapping$group), "~group")
